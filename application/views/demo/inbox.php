...
<div class="message-header clearfix">
	<div class="pull-left">
		...
		&nbsp;
		<img class="middle" alt="John's Avatar" src="<?= base_url(); ?>demo/avatars/avatar.png" width="32" />
		&nbsp;
...
<div class="message-attachment clearfix">
	...
	<div class="attachment-images pull-right">
		...
		<div>
			<img width="36" alt="image 4" src="<?= base_url(); ?>demo/gallery/thumb-4.jpg" />
			<img width="36" alt="image 3" src="<?= base_url(); ?>demo/gallery/thumb-3.jpg" />
			<img width="36" alt="image 2" src="<?= base_url(); ?>demo/gallery/thumb-2.jpg" />
			<img width="36" alt="image 1" src="<?= base_url(); ?>demo/gallery/thumb-1.jpg" />
		</div>
	</div>
</div>
