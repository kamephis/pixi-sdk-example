...
class More extends SDKMenu
{
    ...
    {
        // Loading view
        $inbox = $this->load->view('demo/inbox', null, true);
        ...
        $this->loadMainView('Inbox', 'Mailbox with some customizations as described in docs', $inbox, $htmlTop, $htmlBottom);
    }
    
    public function pricing()
    {
        // Loading view
        $pricing = $this->load->view('demo/pricing', null, true);
        
        $this->loadMainView('Pricing Tables', 'Large & Small', $pricing, null, null);
    }
    
    public function invoice()
    {
        // Loading view
        $invoice = $this->load->view('demo/invoice', null, true);
        
        $this->loadMainView('', '', $invoice, null, null);
    }
    
    public function timeline()
    {
        // Loading view
        $timeline = $this->load->view('demo/timeline', null, true);
        ...
        $this->loadMainView('Timeline', 'based on widget boxes with 2 different styles', $timeline, null, null);
    }
}
